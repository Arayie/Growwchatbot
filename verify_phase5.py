...
def run_phase5_evaluation():
    ...
    eval_test_cases = [
        # (a) Exact Factual Queries
        {
            ...
            "check_fn": lambda res: res["status"] == "success" and "500" in res["answer"] and "Source:" in res["answer"]
        },
        {
            "id": 2,
            "category": "Exact Factual - Exit Load",
            "query": "What is the exit load for SBI Bluechip Fund Direct Growth?",
            "check_fn": lambda res: res["status"] == "success" and "1%" in res["answer"] and "Source:" in res["answer"]
        },
        {
            "id": 3,
            "category": "Exact Factual - Expense Ratio",
            "query": "What is the expense ratio for SBI Gold Fund Direct Growth?",
            "check_fn": lambda res: res["status"] == "success" and "0.10%" in res["answer"] and "Source:" in res["answer"]
        },
        {
            "id": 4,
            "category": "Exact Factual - NAV Value",
            "query": "What is the NAV of SBI Long Term Equity ELSS Direct Growth?",
            "check_fn": lambda res: res["status"] == "success" and "385.60" in res["answer"] and "Source:" in res["answer"]
        },
